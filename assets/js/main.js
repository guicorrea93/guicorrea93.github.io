...
const CONFIG = {
  ...
  booksPath: 'data/livros.json',
  studiesPath: 'data/estudos.json',
...
// ===============================
function initWorkProcessToggle() {
...
// Adicione este código ao main.js
// ===============================
...
// Atualiza CONFIG
CONFIG.booksPath = 'data/livros.json';
...
function renderAllBooks(books, filter = 'all', searchTerm = '') {
  ...
  // Aplica filtro de gênero/coleção
  if (filter !== 'all') {
  ...
  statsContainer.innerHTML = `
    <div class="book-stats-grid">
      ...
      <div class="book-stat-card">
        ...
        <div class="book-stat-label">Páginas</div>
      </div>
      ...
      <div class="book-stat-card">
        ...
        <div class="book-stat-label">Média</div>
      </div>
    </div>
  `;
}
...
function generateBookFilters(books) {
  ...
  // Coleta gêneros e coleções únicos
...
function initComoTrabalho() {
  ...
  // 2) Animação de entrada (só dentro da seção)
...
/*
  ✅ IMPORTANTE:
  Para NÃO mexer no seu "bootstrap" atual do main.js, eu chamo isso
  em DOMContentLoaded e também tento chamar depois de load (caso seu
  main.js já tenha outras inicializações).
*/
